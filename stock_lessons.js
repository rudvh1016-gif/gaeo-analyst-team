...
// cat: 중카테고리 키(beginner/chart/capitalism/crisis/tax/product/macro/industry), index.html의 LESSON_CATS 참조
const STOCK_LESSONS = [
{
 "id": 71,
 "date": "2026-08-03",
...
| 유형 | 주식 | 채권 | 현금성 | 어울리는 상황 |
|---|---:|---:|---:|---|
| 안정형 예시 | 30% | 50% | 20% | 사용 시점이 가깝거나 큰 하락을 견디기 어려움 |
| 균형형 예시 | 60% | 30% | 10% | 7년 이상 장기 목표와 중간 수준의 변동 감수 |
| 성장형 예시 | 80% | 15% | 5% | 소득이 안정적이고 장기 하락을 견딜 수 있음 |
...
| 상황 | 일반적인 세금 | 누가 처리하나요 |
|---|---|---|
| 상장주식 매수 | 별도 주식 취득세 없음 | 증권사 수수료만 확인 |
| 현금배당 수령 | 배당소득 원천징수 15.4% | 지급 때 자동 원천징수 |
| 상장주식 장내 매도 | 증권거래세 등 | 증권사가 매도대금에서 자동 차감 |
| 상장주식 장내 매매차익 | 일반 소액주주는 보통 양도세 없음 | 대주주 등 예외는 직접 신고 |
| 장외·비상장주식 양도 | 양도소득세 대상 가능 | 납세자가 신고·납부 |
...
| 재무제표 | 무엇을 보여주나요 | 먼저 볼 항목 |
|---|---|---|
| 손익계산서 | 분기·연간 동안 벌고 쓴 결과 | 매출, 매출총이익, 영업이익, 순이익 |
| 재무상태표 | 결산일 현재 가진 것과 갚을 것 | 현금, 매출채권, 재고, 차입금, 자본 |
| 현금흐름표 | 실제 현금이 어디서 들어오고 나갔는지 | 영업·투자·재무활동 현금흐름 |
...
| 구분 | S&P500 | 나스닥100 |
|---|---|---|
| 목적 | 미국 대형주 시장의 폭넓은 대표성 | 나스닥 상장 대형 비금융 기업 대표 |
| 종목 수 | 500개 주요 기업 | 100개 비금융 기업 |
| 상장시장 | 미국 기업 요건과 선정 기준 충족, 상장 거래소가 나스닥에 한정되지 않음 | 나스닥 상장 종목 중심 |
| 금융주 | 포함 가능 | 금융회사 제외 |
| 업종 특성 | 정보기술 외 금융·헬스케어·산업재·소비재 등 더 넓음 | 기술·통신·소비 중심 비중이 상대적으로 큼 |
| 집중도 | 대형주 비중이 크지만 상대적으로 넓게 분산 | 상위 대형 성장주의 영향이 더 큼 |
| 일반적 변동성 | 상대적으로 낮은 편 | 상승·하락 폭이 더 커질 수 있음 |
...
- [Nasdaq 나스닥100 방법론](https://indexes.nasdaqomx.com/docs/methodology_NDX.pdf)
