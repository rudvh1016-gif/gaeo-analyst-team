...
const MODEL_INTELLIGENCE = {
 ...
 "confidenceModel": {
  ...
  "prospective": {
   ...
   "sellN": 471,
   "tierSpreadPp": 37.0,
   "tierSpreadWithinBuyPp": 11.6,
   "tierSpreadWithinSellPp": 14.0,
   "clockStarted": true,
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 확신도가 기존보다 실제 적중률을 더 잘 가른다는 근거 부족(후보 5.2pp vs 기존 8.3pp)",
    "후보 판별력 95% 구간(-4.8~38.4pp)이 0을 포함해 우연일 가능성을 배제하지 못함",
