...
const MODEL_INTELLIGENCE = {
 ...
 "shadow": {
  "n": 7781,
  "baselineActionN": 1935,
  "baselineActionPrecision": 51.3,
  "candidateActionN": 0,
 ...
 "confidenceModel": {
  ...
  "evaluationDesign": {
   ...
   "totalDecisionDays": 57,
   "trainDays": 34,
   "embargoDays": 5,
   "holdoutDays": 18,
   "holdoutSharePct": 31.6,
   "estimatedTotalDaysForGate": 175,
   "isProspective": false
  },
  "prospective": {
   ...
   "sellN": 376,
   "tierSpreadPp": 32.3,
   "tierSpreadWithinBuyPp": 17.2,
   "tierSpreadWithinSellPp": 16.8,
   "clockStarted": true,
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 확신도가 기존보다 실제 적중률을 더 잘 가른다는 근거 부족(후보 2.2pp vs 기존 4.3pp)",
    "후보 판별력 95% 구간(-9.8~34.8pp)이 0을 포함해 우연일 가능성을 배제하지 못함",
    "같은 방향 안에서 다시 재면 판별력이 약함(BUY 6.2pp · SELL -1.2pp)",
