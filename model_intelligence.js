...
const MODEL_INTELLIGENCE = {
 ...
 "shadow": {
  "n": 7182,
  "baselineActionN": 1792,
  "baselineActionPrecision": 50.1,
  "candidateActionN": 0,
 ...
 "confidenceModel": {
  ...
  "promotion": {
   ...
   "reasons": [
    ...
    "후보 판별력 95% 구간(-12.3~32.5pp)이 0을 포함해 우연일 가능성을 배제하지 못함",
    "같은 방향 안에서 다시 재면 판별력이 약함(BUY 7.5pp · SELL -6.9pp)",
