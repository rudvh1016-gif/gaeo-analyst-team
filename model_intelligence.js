...
const MODEL_INTELLIGENCE = {
 ...
 "confidenceModel": {
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 판별력 95% 구간(-12.3~30.2pp)이 0을 포함해 우연일 가능성을 배제하지 못함",
    "같은 방향 안에서 다시 재면 판별력이 약함(BUY 1.8pp · SELL 1.5pp)",
