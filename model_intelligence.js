...
const MODEL_INTELLIGENCE = {
 ...
 "shadow": {
  "n": 6582,
  "baselineActionN": 1554,
  "baselineActionPrecision": 46.3,
  "candidateActionN": 0,
 ...
 "confidenceModel": {
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 판별력 95% 구간(-13.0~30.9pp)이 0을 포함해 우연일 가능성을 배제하지 못함",
    "같은 방향 안에서 다시 재면 판별력이 약함(BUY -4.1pp · SELL -1.0pp)",
