...
const MODEL_INTELLIGENCE = {
 ...
 "confidenceModel": {
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 확신도가 기존보다 실제 적중률을 더 잘 가른다는 근거 부족(후보 -3.8pp vs 기존 1.4pp)",
    "후보 판별력 95% 구간(-12.7~25.2pp)이 0을 포함해 우연일 가능성을 배제하지 못함",
    "같은 방향 안에서 다시 재면 판별력이 약함(BUY -0.8pp · SELL 0.0pp)",
