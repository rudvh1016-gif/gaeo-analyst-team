...
const MODEL_INTELLIGENCE = {
 ...
 "shadow": {
  ...
  "candidateActionN": 2594,
  "candidateActionPrecision": 43.2,
  "candidateCoverage": 86.3,
  "candidateCalls": {
   "BUY": 0,
   "HOLD": 11,
   "SELL": 2996
 ...
 "confidenceModel": {
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 확신도가 기존보다 실제 적중률을 더 잘 가른다는 근거 부족(후보 -11.4pp vs 기존 -10.0pp)"
   ],
   "minimums": {
    "testDays": 40,
    "buyN": 50,
