...
const MODEL_INTELLIGENCE = {
 ...
 "confidenceModel": {
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 확신도가 기존보다 실제 적중률을 더 잘 가른다는 근거 부족(후보 -6.1pp vs 기존 3.5pp)"
   ],
   "minimums": {
    "testDays": 40,
    "buyN": 50,
