...
const MODEL_INTELLIGENCE = {
 ...
 "confidenceModel": {
  ...
  "prospective": {
   ...
   "sellN": 562,
   "tierSpreadPp": 32.5,
   "tierSpreadWithinBuyPp": 7.3,
   "tierSpreadWithinSellPp": 2.1,
   "clockStarted": true,
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 판별력 95% 구간(-4.2~36.1pp)이 0을 포함해 우연일 가능성을 배제하지 못함",
    "같은 방향 안에서 다시 재면 판별력이 약함(BUY 3.0pp · SELL -5.7pp)",
