...
const MODEL_INTELLIGENCE = {
 ...
 "prospective": {
  ...
  "candidateActionN": 2760,
  "candidateActionPrecision": 35.0,
  "candidateCoverage": 78.9,
  "candidateCalls": {
   "BUY": 0,
   "HOLD": 350,
   "SELL": 3150
 ...
 "confidenceModel": {
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 확신도가 기존보다 실제 적중률을 더 잘 가른다는 근거 부족(후보 -11.4pp vs 기존 -10.6pp)"
   ],
   "minimums": {
    "testDays": 40,
    "buyN": 50,
