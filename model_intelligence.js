...
const MODEL_INTELLIGENCE = {
 ...
 "shadow": {
  ...
  "candidateActionN": 2183,
  "candidateActionPrecision": 20.9,
  "candidateCoverage": 87.2,
  "candidateCalls": {
   "BUY": 0,
   "HOLD": 0,
   "SELL": 2503
 ...
 "confidenceModel": {
  ...
  "promotion": {
   ...
   "reasons": [
    "검증일 40거래일 미만",
    "후보 확신도가 기존보다 실제 적중률을 더 잘 가른다는 근거 부족(후보 -15.2pp vs 기존 -3.6pp)"
   ],
   "minimums": {
    "testDays": 40,
    "buyN": 50,
