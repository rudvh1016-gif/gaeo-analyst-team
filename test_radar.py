...
import compute_radar as C
check("지연 종목(마지막 봉이 기준일보다 오래됨)은 그 회차 검사에서 뺀다",
      C.is_stale([{"date": "2026-09-16"}], "2026-09-17")
      and not C.is_stale([{"date": "2026-09-17"}], "2026-09-17")
      and not C.is_stale([{"date": "2026-09-17"}], "")
      and C.latest_bar_date({"a": {"daily": [{"date": "2026-09-16"}]}, "b": {"daily": [{"date": "2026-09-17"}]}, "c": {}}) == "2026-09-17")
