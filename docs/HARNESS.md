...
| 예정 시험 | `python3 gaeo_check.py schedule` | 일정 원본↔문서 동기·allowlist·원장 형식 (+ 구간 5 실행기 계약) |
...
- 예정 시험: `docs/VALIDATION_SCHEDULE.md` · 투자검증: `docs/gaeo_validation_policy.md` · `docs/PREREGISTRATION_BUY_FILTERS_20260905.md`
