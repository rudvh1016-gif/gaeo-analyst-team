...
2026-09-14 소유자 확정: **600종목 시장지도 전용**으로 상승=초록, 하락=빨강,
보합=회색, 시세 지연/확인 불가=별도 중립색을 쓴다. 단계별 범례와 등락률 숫자를
같이 표시한다. `.market-map-view` 안에만 적용하고, 홈 미리보기·성적표·종목 상세·
BUY/SELL 판단색은 기존 규칙을 유지한다. 종목별 동일 면적도 유지한다.
