...
- 이 세션에는 일회성 Routine 3개가 더 예약돼 있다(2026-09-05 기준). **2026-09-15 17:00 KST** 「DIANA 채점 시작 전환 확인」(`trig_016K7aG2LNfyo6mK4APHnTeK`), **2026-09-23 17:00 KST** 「수급(FLOW) 산식 검증 + BUY 사전등록 표본 점검」(`trig_015MuVabAYTLDXistNBJ8wE4`), **2026-10-19 17:00 KST** 「BUY 필터 사전등록 확정 평가」(`trig_015gDtdaSXyuJnnU76PYcdDA`). 모두 `docs/PREREGISTRATION_BUY_FILTERS_20260905.md`·`docs/gaeo_validation_policy.md` §13~§14의 사전등록 규칙을 따른다. 결과를 보고 임계값·가설을 바꾸면 등록이 소멸하므로, 그 전에 산식을 손대지 말 것.
